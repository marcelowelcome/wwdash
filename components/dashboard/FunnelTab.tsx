...
export function FunnelTab({ m }: FunnelTabProps) {
    ...
    return (
        <div style={{ display: "flex", flexDirection: "column", gap: 32 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 18 }}>
                ...
                <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 12, padding: "20px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 12 }}>
                        <span style={{ color: m.sdrThisWeek >= m.sdrAvg4 ? T.green : T.red }}>
            ...
            <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 12, padding: "20px 22px" }}>
                <SectionTitle>FUNIL SDR — etapas e taxas de passagem (Última Semana)</SectionTitle>
            ...
            <div style={{ background: T.card, border: `1px solid ${T.border}`, borderRadius: 12, padding: "20px 22px" }}>
                ...
                <ResponsiveContainer width="100%" height={240}>
                    <LineChart data={m.sdrTaxaTrend} margin={{ top: 20, right: 20, bottom: 0, left: -20 }}>
                        ...
                        {/* Picos Históricos */}
                        <ReferenceLine yAxisId="0" y={77} stroke={T.red} strokeDasharray="3 3" label={{ position: 'top', value: 'Ago/24: 77%', fill: T.red, fontSize: 10 }} />
                        <ReferenceLine yAxisId="0" y={72} stroke={T.red} strokeDasharray="3 3" label={{ position: 'top', value: 'Jan/25: 72%', fill: T.red, fontSize: 10 }} />
                    </LineChart>
                </ResponsiveContainer>
            </div>
